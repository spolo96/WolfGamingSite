define(["require", "exports", "tslib", "react", "../../Utilities", "../../Image", "./PersonaPresence", "./Persona.Props", "./PersonaConsts", "./Persona.scss"], function (require, exports, tslib_1, React, Utilities_1, Image_1, PersonaPresence_1, Persona_Props_1, PersonaConsts_1, stylesImport) {
    "use strict";
    ...
    var PersonaCoin = (function (_super) {
        ...
        PersonaCoin.prototype.render = function () {
            var _a = this.props, className = _a.className, imageUrl = _a.imageUrl, imageAlt = _a.imageAlt, initialsColor = _a.initialsColor, presence = _a.presence, primaryText = _a.primaryText, imageShouldFadeIn = _a.imageShouldFadeIn, _b = _a.onRenderInitials, onRenderInitials = _b === void 0 ? this._onRenderInitials : _b, imageShouldStartVisible = _a.imageShouldStartVisible;
