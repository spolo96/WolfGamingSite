            ...
            return (React.createElement("div", { className: 'ms-basicSlider' },
                ...
                React.createElement("div", { className: 'ms-SliderVertical ' },
                    React.createElement("div", { className: 'ms-verticalBox' },
                        React.createElement(Slider_1.Slider, { label: 'Basic example:', min: 1, max: 3, step: 1, defaultValue: 2, showValue: true, vertical: true, onChange: function (value) { return console.log(value); } })),
                    React.createElement("div", { className: 'ms-verticalBox' },
