define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Utilities", "office-ui-fabric-react/lib/HoverCard", "office-ui-fabric-react/lib/DetailsList", "office-ui-fabric-react/lib/common/DirectionalHint", "office-ui-fabric-react/lib/Utilities", "@uifabric/example-app-base", "./HoverCard.Example.scss"], function (require, exports, tslib_1, React, Utilities_1, HoverCard_1, DetailsList_1, DirectionalHint_1, Utilities_2, example_app_base_1) {
    "use strict";
        ...
        HoverCardField.prototype.render = function () {
            ...
            return (React.createElement("div", { ref: function (c) { return !_this.state.contentRendered && _this.setState({ contentRendered: c }); } },
                ...
                this.state.contentRendered &&
                    React.createElement(HoverCard_1.HoverCard, { expandingCardProps: this.props.expandingCardProps, target: this.state.contentRendered, cardDismissDelay: 300, onCardVisible: function () { return console.log('onCardVisible'); }, onCardHide: function () { return console.log('onCardHide'); } })));
        };
