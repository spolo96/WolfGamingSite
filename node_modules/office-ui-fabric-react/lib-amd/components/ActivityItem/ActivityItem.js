define(["require", "exports", "tslib", "react", "../../Utilities", "../../Styling", "./ActivityItem.styles", "office-ui-fabric-react/lib/Persona", "office-ui-fabric-react/lib/PersonaCoin"], function (require, exports, tslib_1, React, Utilities_1, Styling_1, ActivityItem_styles_1, Persona_1, PersonaCoin_1) {
    "use strict";
            ...
            if (activityPersonas[0].imageUrl || activityPersonas[0].imageInitials) {
                ...
                activityPersonas.filter(function (person, index) { return index < personaLimit_1; }).forEach(function (person, index) {
                    personaList_1.push(React.createElement(PersonaCoin_1.PersonaCoin, tslib_1.__assign({}, person, { 
                        ...
                        key: person['key'] ? person['key'] : index, className: _this._classNames.activityPersona, size: showSize16Personas_1 ? Persona_1.PersonaSize.size16 : Persona_1.PersonaSize.extraSmall, style: style_1 })));
                });
