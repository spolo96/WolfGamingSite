        ...
        ButtonDefaultExample.prototype.render = function () {
            ...
            return (React.createElement("div", { className: 'ms-BasicButtonsTwoUp' },
                ...
                React.createElement("div", null,
                    ...
                    React.createElement(Button_1.DefaultButton, { primary: true, "data-automation-id": 'test', disabled: disabled, checked: checked, text: 'Butjon', onClick: function () { return alert('Clicked'); } }))));
        };
