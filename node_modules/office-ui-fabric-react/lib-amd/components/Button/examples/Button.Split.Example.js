        ...
        ButtonSplitExample.prototype.render = function () {
            ...
            return (React.createElement("div", { className: 'ms-BasicButtonsTwoUp' },
                ...
                React.createElement("div", null,
                    ...
                    React.createElement(Button_1.DefaultButton, { primary: true, "data-automation-id": 'test', disabled: disabled, checked: checked, text: 'Create account', onClick: function () { return alert('Clicked'); }, split: true, menuProps: {
                            items: [
                                {
                                    key: 'emailMessage',
                                    name: 'Email message',
    ...
    var ButtonSplitCustomExample = (function (_super) {
        ...
        ButtonSplitCustomExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                ...
                React.createElement(Button_1.IconButton, { "data-automation-id": 'test', disabled: disabled, checked: checked, iconProps: { iconName: 'Emoji2' }, text: 'Create account', onClick: function () { return alert('Clicked'); }, split: true, styles: customSplitButtonStyles, menuProps: {
                        items: [
                            {
                                key: 'emailMessage',
                                name: 'Email message',
