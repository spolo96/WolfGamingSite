    ...
    var DetailsListDocumentsExample = (function (_super) {
        ...
        DetailsListDocumentsExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                React.createElement(Toggle_1.Toggle, { label: 'Enable Compact Mode', checked: isCompactMode, onChanged: this._onChangeToggle, onText: 'Compact', offText: 'Normal' }),
                ...
                React.createElement(MarqueeSelection_1.MarqueeSelection, { selection: this._selection },
                    React.createElement(DetailsList_1.DetailsList, { items: items, compact: isCompactMode, columns: columns, setKey: 'set', layoutMode: DetailsList_1.DetailsListLayoutMode.justified, isHeaderVisible: true, selection: this._selection, selectionPreservedOnEmptyClick: true, onItemInvoked: this._onItemInvoked }))));
        };
        DetailsListDocumentsExample.prototype._onChangeToggle = function (checked) {
        ...
        ], DetailsListDocumentsExample.prototype, "_onChangeToggle", null);
        tslib_1.__decorate([
            Utilities_1.autobind
