define(["require", "exports", "tslib", "react", "@uifabric/example-app-base", "./examples/ContextualMenu.Basic.Example", "./examples/ContextualMenu.Section.Example", "./examples/ContextualMenu.Checkmarks.Example", "./examples/ContextualMenu.Directional.Example", "./examples/ContextualMenu.Customization.Example", "./examples/ContextualMenu.Header.Example"], function (require, exports, tslib_1, React, example_app_base_1, ContextualMenu_Basic_Example_1, ContextualMenu_Section_Example_1, ContextualMenu_Checkmarks_Example_1, ContextualMenu_Directional_Example_1, ContextualMenu_Customization_Example_1, ContextualMenu_Header_Example_1) {
    "use strict";
    ...
    var ContextualMenuPage = (function (_super) {
        ...
        ContextualMenuPage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'ContextualMenu', componentName: 'ContextualMenuExample', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(example_app_base_1.ExampleCard, { title: 'ContextualMenu section example', code: ContextualMenuSectionExampleCode },
