...
exports.Icon = function (props) {
    var ariaLabel = props.ariaLabel, className = props.className, onClicked = props.onClicked, customStyles = props.styles, iconName = props.iconName;
    ...
    if (props.iconType === Icon_Props_1.IconType.image || props.iconType === Icon_Props_1.IconType.Image) {
        ...
        }), Utilities_1.getNativeProps(props, Utilities_1.htmlElementProperties), { className: Utilities_1.css('ms-Icon', styles.root, props.className), onClick: onClicked }), Styling_1.IconCodes[iconMemberName]));
    }
};
