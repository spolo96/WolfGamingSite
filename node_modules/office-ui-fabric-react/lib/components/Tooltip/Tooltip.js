...
var Tooltip = (function (_super) {
    ...
    Tooltip.prototype.render = function () {
        ...
        return (React.createElement(Callout_1.Callout, tslib_1.__assign({ className: Styling_1.mergeStyles('ms-Tooltip', Styling_1.AnimationClassNames.fadeIn200, styles.root, (delay === Tooltip_Props_1.TooltipDelay.medium) && styles.hasMediumDelay, (maxWidth !== null) && { maxWidth: maxWidth }), targetElement: targetElement, directionalHint: directionalHint, directionalHintForRTL: directionalHintForRTL }, calloutProps, Utilities_1.getNativeProps(this.props, Utilities_1.divProperties)),
